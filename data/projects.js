const projectsData = {
  en: [
    {
      id: "project1",
      title: "UCL East Extension Design",
      image: "images/ucl_east.jpg",
      alt: "Architectural render of UCL East Marshgate",
      description: [
    ...
    {
      id: "project2",
      title: "Revit - Point Cloud",
      image: "images/revitbox.jpg",
      alt: "A 3D model created in Revit software",
      description: [
    ...
    },
    {
      ...
      image: "images/landsurveyingbox.jpg",
      alt: "A person using land surveying equipment outdoors",
      description: [
  ...
  fr: [
    {
      id: "project1",
      title: "Design d'extension d'UCL East",
      image: "images/ucl_east.jpg",
      alt: "Architectural render of UCL East Marshgate",
      description: [
