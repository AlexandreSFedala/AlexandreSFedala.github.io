    ...
    en: [
        {
            ...
            content: [
                ...
                "My goal as a civil engineer is to create tangible, positive change in the built environment — developing solutions that serve clients, end-users, and local communities alike.",
        ...
        },
        {
            ...
            type: "text",
            content: [
                "I have a particular interest in vernacular design, ensuring that buildings and infrastructure respond to local needs and integrate seamlessly into their surroundings.",
    ...
    fr: [
        {
            ...
            content: [
                ...
                "Mon objectif en tant qu'ingénieur civil est d'apporter un changement concret et positif à l'environnement bâti — en développant des solutions qui servent les clients, les utilisateurs finaux et les communautés locales.",
        ...
        },
        {
            ...
            type: "text",
            content: [
                "J'ai un intérêt particulier pour l'architecture vernaculaire, afin que les bâtiments et infrastructures répondent aux besoins locaux et s'intègrent harmonieusement à leur environnement.",
